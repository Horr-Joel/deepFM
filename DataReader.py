...
class FeatureDictionary(object):
    def __init__(self, trainfile=None, testfile=None,
                 dfTrain=None, dfTest=None, numeric_cols=[], ignore_cols=[]): #multivalued_cols=[]
        ...
        #---------------------增加多值特征列-------------------------
        self.multivalued_cols = multivalued_cols
    ...
    def gen_feat_dict(self):
        ...
        for col in df.columns:
            ...
            if col in self.numeric_cols:
                ...
                tc += 1
            #---------------------增加对多值特征的映射-------------------------
            elif col in self.multivalued_cols:
                us = set()
...
class DataParser(object):
    ...
    def parse(self, infile=None, df=None, has_label=False):
        ...
        for col in dfi.columns:
            ...
            #---------------------增加对多值特征的映射-------------------------
            elif col in self.feat_dict.multivalued_cols:
                tmp=[]
                for each in str(dfi[col]).split():
                    each = each.map(self.feat_dict.feat_dict[col])
                    tmp.append(each)
                dfi[col] = tmp
                del tmp
                dfv[col] = 1.
